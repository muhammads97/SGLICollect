...
parser.add_argument('-r', "--resolution", nargs="?", type=str,
                    default="250m", help="resolution for GPortal (250m or 1000m)")
...
parser.add_argument("--download-dir", type=Path, default=TEMP_FOLDER, help="directory path of the download location")
